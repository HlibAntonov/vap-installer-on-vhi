...
echo
echo "   CREATE NEW Virtuozzo Application Management:"
echo "       COMMAND:  "
...
echo "             --vap-platform-data-vz-size - Virtuozzo Application Management data storage volume size in GB"
